  ...
  <div class="generated-itinerary">
    ...
    <div class="container">
      ...
      <div v-else class="row justify-content-center">
        <div class="col-lg-12 col-md-10"> <!-- Ensure the itinerary is centered and narrower -->
